...
export default function SongEditor() {
  ...
  const actualTextHeight = (layout.baseFontSize || 16) * 1.2;
          ...
          >
            ...
            {song && paginateSong(song, baseLinesPerColumn, activeColumns).map((page, index) => (
              ...
              >
                ...
                <div className={`grid grid-cols-1 ${({ 1: 'md:grid-cols-1', 2: 'md:grid-cols-2', 3: 'md:grid-cols-3', 4: 'md:grid-cols-4' } as Record<number, string>)[activeColumns] || 'md:grid-cols-1'} gap-8 sm:gap-12 w-full mt-2 flex-grow items-start`}>
