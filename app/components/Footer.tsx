  ...
  return (
    <footer className="bg-zinc-100 dark:bg-zinc-950 border-t border-border relative z-10 w-full mt-auto">
       <div className="max-w-[1800px] mx-auto px-6 sm:px-12 lg:px-16 py-20 flex flex-col md:flex-row justify-between gap-16">
          <div className="flex-1">
             ...
             <p className="text-muted-foreground max-w-sm leading-relaxed text-sm">
               La plataforma definitiva para la arquitectura musical. Transcribe, presenta y vende tus obras a la comunidad global.
             </p>
          </div>
          
          <div className="flex gap-16">
            <div className="flex flex-col gap-4">
               <h4 className="font-bold uppercase tracking-widest text-[10px] text-primary">Plataforma</h4>
               <Link href="/editor" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Estudio</Link>
               <Link href="/community" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Comunidad</Link>
               <Link href="/pricing" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Planes Pro</Link>
            </div>
            <div className="flex flex-col gap-4">
       ...
       <div className="border-t border-border py-8 text-center">
          <p className="text-xs text-muted-foreground font-bold tracking-widest uppercase">© 2026 AuraChords. All rights reserved.</p>
       </div>
    </footer>
  );
}
